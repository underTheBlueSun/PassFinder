...
var items: [Item] = [
    ...
    Item(category: "나의 판단 방식은?", type1: "T04", title1: "논쟁에서 차분하고 논리적으로 말을 잘한다", type2: "F04", title2: "논쟁에서 감정이 상한적이 종종 있다", image: "category3"),
    Item(category: "나의 판단 방식은?", type1: "T05", title1: "공평하고 정의로운 사람이 더 되고 싶다", type2: "F05", title2: "친절하고 따뜻한 사람이 더 되고 싶다", image: "category3"),
    Item(category: "나의 판단 방식은?", type1: "T06", title1: "슬픈 영화를 봐도 무덤덤하다", type2: "F06",  title2: "슬픈 영화를 보면 눈물이 난다", image: "category3"),
